...
Describe 'Arrays' {
    ...
    It 'is a fixed size collection; elements cannot be added or removed' {
        ...
        { $Ages.Add(59) } | Should -Throw -ExpectedMessage 'Rozmiar kolekcji jest stały.'
        { $Ages.Remove(12) } | Should -Throw -ExpectedMessage 'Rozmiar kolekcji jest stały.'
    }
    ...
    It 'is usually of type Object[]' {
        ...
        [System.Object[]] | Should -Be $Strings.GetType()
