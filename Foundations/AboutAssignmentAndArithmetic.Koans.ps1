...
Describe 'Arithmetic Operators' {
    ...
    Context 'Division' {
        ...
        It 'is restricted to numeric use only' {
            ...
            #>
            { 'hello!' / 3 } | Should -Throw -ExpectedMessage 'Cannot convert value "hello!" to type "System.Int32". Error: "Nieprawidłowy format ciągu wejściowego."'
    ...
    Context 'Modulus' {
        ...
        It 'cannot be used on non-numeric values' {
            ...
            $ModulusOnString | Should -Throw -ExpectedMessage 'Cannot convert value "hello!" to type "System.Int32". Error: "Nieprawidłowy format ciągu wejściowego."'
            ...
            # broken << Parameter 'Throw' cannot be specified in parameter set 'Legacy'. >> $ModulusOnArray | Should -Throw -ExpectedMessage 'Method invocation failed because [System.Object[]] does not contain a method named 'op_Modulus'.'
        }
    }
}
