...
Describe 'Strings' {
    ...
    Context 'Evaluated Strings' {
        ...
        It 'can do a simple expansion' {
            'Your home directory is: C:\Users\pbiazik' | Should -Be "Your home directory is: $HOME"
        }
        ...
        It 'handles other ways of doing the same thing' {
            ...
            'Your home folder is: C:\Users\pbiazik' | Should -Be $String
        }
...
"@
            ...
            'I am number #3!' | Should -Be $String
        }
